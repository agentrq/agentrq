...
// It uses crypto/rand and math/big to ensure uniform distribution (no modulo bias).
...
// SecureCompare performs a constant-time string comparison to mitigate timing attacks.
