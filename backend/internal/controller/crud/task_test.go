...
const (
	testUserIDStr = "12345" // Use a string that monoflake can parse if needed, but here it's treated as base62
)
...
func TestCreateTask_Success(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	...
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), gomock.Any())
...
func TestCreateTask_ArchivedWorkspace(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(archived, nil)
...
func TestGetTask_Success(t *testing.T) {
	...
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(task, nil)

	resp, err := c.GetTask(context.Background(), entity.GetTaskRequest{WorkspaceID: 1, TaskID: 10, UserID: testUserIDStr})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGetTask_NotFound(t *testing.T) {
	...
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(99), testUserID).Return(model.Task{}, fmt.Errorf("not found"))

	_, err := c.GetTask(context.Background(), entity.GetTaskRequest{WorkspaceID: 1, TaskID: 99, UserID: testUserIDStr})
	if err == nil {
...
func TestListTasks_Success(t *testing.T) {
	...
	repo.EXPECT().ListTasks(gomock.Any(), gomock.Any(), testUserID).Return(tasks, nil)

	resp, err := c.ListTasks(context.Background(), entity.ListTasksRequest{WorkspaceID: 1, UserID: testUserIDStr})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if len(resp.Tasks) != 2 {
...
func TestListTasks_Empty(t *testing.T) {
	...
	repo.EXPECT().ListTasks(gomock.Any(), gomock.Any(), testUserID).Return([]model.Task{}, nil)
...
func TestRespondToTask_Allow(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(task, nil)
	repo.EXPECT().ListTasks(gomock.Any(), gomock.Any(), testUserID).Return([]model.Task{task}, nil)
	idgen.EXPECT().NextID().Return(int64(100))
	repo.EXPECT().CreateMessage(gomock.Any(), gomock.Any()).Return(nil)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDTaskApproveManual)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDMessageCreate)
	repo.EXPECT().UpdateTask(gomock.Any(), gomock.Any()).Return(updated, nil)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDTaskUpdate)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(updated, nil)
...
func TestRespondToTask_UnknownAction(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(model.Task{ID: 10}, nil)

	_, err := c.RespondToTask(context.Background(), entity.RespondToTaskRequest{
		WorkspaceID: 1, TaskID: 10, Action: "bogus", UserID: testUserIDStr,
	})
	if err == nil {
...
func TestRespondToTask_Allow_BlockedByOngoingTask(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(thisTask, nil)
	repo.EXPECT().ListTasks(gomock.Any(), gomock.Any(), testUserID).Return([]model.Task{thisTask, otherTask}, nil)
...
func TestUpdateTaskStatus_Success(t *testing.T) {
	...
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(task, nil)
	repo.EXPECT().UpdateTask(gomock.Any(), gomock.Any()).Return(updated, nil)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDTaskComplete)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDTaskUpdate)
...
func TestUpdateTaskStatus_Ongoing_BlockedByExistingOngoingTask(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(thisTask, nil)
	repo.EXPECT().ListTasks(gomock.Any(), gomock.Any(), testUserID).Return([]model.Task{thisTask, other}, nil)
...
func TestDeleteTask_Success(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(task, nil)
	repo.EXPECT().DeleteTask(gomock.Any(), int64(1), int64(10), testUserID).Return(nil)
	telSvc.EXPECT().Record(gomock.Any(), testUserID, int64(1), model.ActionIDTaskDelete)
	_ = stor // no attachments in this task

	_, err := c.DeleteTask(context.Background(), entity.DeleteTaskRequest{
		WorkspaceID: 1, TaskID: 10, UserID: testUserIDStr,
	})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestDeleteTask_RepositoryError(t *testing.T) {
	...
	repo.EXPECT().GetWorkspace(gomock.Any(), int64(1), testUserID).Return(activeWorkspace(), nil)
	repo.EXPECT().GetTask(gomock.Any(), int64(1), int64(10), testUserID).Return(task, nil)
	repo.EXPECT().DeleteTask(gomock.Any(), int64(1), int64(10), testUserID).Return(fmt.Errorf("db error"))
...
func TestUpdateTaskOrder_Success(t *testing.T) {
	...
	resp, err := c.UpdateTaskOrder(context.Background(), entity.UpdateTaskOrderRequest{
		WorkspaceID: 1, TaskID: 10, SortOrder: 5.5, UserID: testUserIDStr,
	})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
